...
Run `scripts/validate-skills.sh`, `scripts/validate-doc-sources.sh`, and `scripts/validate-portal-skills.sh` before treating skill, portal-skill, or documentation changes as complete. Pull requests also run validation and CodeQL/code scanning checks.
