...
| Microsoft Scout is a Frontier desktop AI application for Windows and macOS that can act across files, shell, browser, Microsoft 365 data, Work IQ, custom skills, heartbeat, automations, and sub-agents | [Microsoft Scout overview](https://learn.microsoft.com/en-us/microsoft-scout/overview), [Use Microsoft Scout](https://learn.microsoft.com/en-us/microsoft-scout/use-microsoft-scout), and [Microsoft Scout common questions](https://learn.microsoft.com/en-us/microsoft-scout/faq) |
| Microsoft Scout custom skills use `SKILL.md` folders in user-level skill directories such as `~/.copilot/skills/` and `~/.copilot/m-skills/` | [Use Microsoft Scout: Manage skills](https://learn.microsoft.com/en-us/microsoft-scout/use-microsoft-scout#manage-skills) |
| Microsoft Scout access is gated by Frontier, Microsoft 365 admin configuration, Intune policy, organization attestation, Microsoft 365 credentials, Microsoft 365 Copilot access, and GitHub Copilot Business or Enterprise access | [Admin access overview for Microsoft Scout](https://learn.microsoft.com/en-us/microsoft-scout/admin-access-overview), [Get started with Microsoft Scout](https://learn.microsoft.com/en-us/microsoft-scout/get-started), and [Set up Microsoft Scout with Intune](https://learn.microsoft.com/en-us/microsoft-scout/admin-intune-setup) |
| Microsoft Scout responsible AI guidance covers approval, permissions, local files, external AI processing, sensitivity labels, memory, heartbeat, automations, and external content as untrusted data | [Responsible AI overview for Microsoft Scout](https://learn.microsoft.com/en-us/microsoft-scout/microsoft-scout-responsible-ai-overview) and [Responsible AI FAQ for Microsoft Scout](https://learn.microsoft.com/en-us/microsoft-scout/microsoft-scout-responsible-ai-faq) |
| Work IQ provides Microsoft 365 work-context grounding for agents through chat, context, tools, workspaces, A2A, MCP, REST, policy enforcement, observability, and usage-based access | [Work IQ overview](https://learn.microsoft.com/en-us/microsoft-365/copilot/extensibility/work-iq/), [Microsoft Work IQ API](https://learn.microsoft.com/en-us/microsoft-365/copilot/extensibility/work-iq/api-overview), [Work IQ MCP overview](https://learn.microsoft.com/en-us/microsoft-agent-365/tooling-servers-overview), [microsoft/work-iq](https://github.com/microsoft/work-iq), and [microsoft/work-iq-samples](https://github.com/microsoft/work-iq-samples) |
